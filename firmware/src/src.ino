...
const byte version = 99;         // firmware version divide by 10 to get version number e,g 16 = v1.6
...
void setup()
{
  ...
  Serial.begin(115200);
  Serial.print("emonTx V3.4 CUSTOM Discrete Sampling V"); Serial.println(version*0.1);
